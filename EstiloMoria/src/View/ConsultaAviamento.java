 ...
 */
public class ConsultaAviamento extends javax.swing.JFrame {
    ...
    public ConsultaAviamento() throws SQLException {
        initComponents();
        ...
        setResizable(false);
        con_produto.executeSQL("select * from aviamento order by nm_aviamento");
        
        try {
            
            while(con_produto.resultset.next())
                cmbproduto.addItem(con_produto.resultset.getString("nm_aviamento"));
...
// Enter simula tecla Tab
    ...
    private void initComponents() {
        ...
        btncadastrar.setBounds(10, 100, 80, 30);
...
// TODO add your handling code here:
        ...
        if(iniciacombo == 1){
            try {
                ...
                String igual = "n";
                while(igual == "n"){
                    if(con_produto.resultset.getString("nm_aviamento").equals(cmbproduto.getSelectedItem())){
                        igual = "s";
                    } else
                        con_produto.resultset.next();
                }
                txtcodigo.setText(con_produto.resultset.getString(String.valueOf("cd_aviamento")));
...
// TODO add your handling code here:
        ...
        try {
            ...
            if(txtproduto.getText().equals("")||txtproduto.getText().equals("-") ){
                ...
                JOptionPane.showMessageDialog(null,"Selecione um aviamento!");
                cmbproduto.requestFocus();
            } else{
                
                String sql1 = "UPDATE Aviamento Set nm_aviamento='"+txtproduto.getText().toUpperCase()+"' where cd_aviamento ='"+(txtcodigo.getText())+"'";
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ConsultaAviamento().setVisible(true);
                } catch (SQLException ex) {
                    ex.printStackTrace();
                }
            }

 ...
 */
public class VendaCarteira extends javax.swing.JFrame {
    ...
    public VendaCarteira() {
        ...
        con_contapagar1.executeSQL("select * from contareceber");
...
//            Date data = null;
            ...
            if (cmbparcela.getSelectedItem().equals("1")) {
                ...
                try {
                    ...
                    String sqlinsertcontap = "INSERT INTO ContaReceber (cd_cliente, vl_valor, dt_contareceber, dt_venda, vl_total) VALUES( '"+
            ...
            if (cmbparcela.getSelectedItem().equals("2")) {
                ...
                try {
                    ...
                    String sqlinsertcontap2 = "INSERT INTO ContaReceber (cd_cliente, vl_valor, dt_contareceber, dt_venda, vl_total) VALUES( '"+
                            Integer.parseInt(txtcodigo.getText())+"','"+
                            Double.parseDouble(txtparcela2.getText())+"','"+
                            data2+"','"+
                            data+"','"+
                            Double.parseDouble(lblsaldo.getText())+"')";
                    con_contapagar1.statement.executeUpdate(sqlinsertcontap2);
            ...
            if (cmbparcela.getSelectedItem().equals("3")) {
                ...
                try {
                    ...
                    String sqlinsertcontap3 = "INSERT INTO ContaReceber (cd_cliente, vl_valor, dt_contareceber, dt_venda, vl_total) VALUES( '"+
                            Integer.parseInt(txtcodigo.getText())+"','"+
                            Double.parseDouble(txtparcela3.getText())+"','"+
                            data3+"','"+
                            data+"','"+
                            Double.parseDouble(lblsaldo.getText())+"')";
                    con_contapagar1.statement.executeUpdate(sqlinsertcontap3);
            ...
            if (cmbparcela.getSelectedItem().equals("4")) {
                ...
                try {
                    ...
                    String sqlinsertcontap4 = "INSERT INTO ContaReceber (cd_cliente, vl_valor, dt_contareceber, dt_venda, vl_total) VALUES( '"+
                            Integer.parseInt(txtcodigo.getText())+"','"+
                            Double.parseDouble(txtparcela4.getText())+"','"+
                            data4+"','"+
                            data+"','"+
                            Double.parseDouble(lblsaldo.getText())+"')";
                    con_contapagar1.statement.executeUpdate(sqlinsertcontap4);
            ...
            if (cmbparcela.getSelectedItem().equals("5")) {
                ...
                try {
                    ...
                    String sqlinsertcontap5 = "INSERT INTO ContaReceber (cd_cliente, vl_valor, dt_contareceber, dt_venda, vl_total) VALUES( '"+
                            Integer.parseInt(txtcodigo.getText())+"','"+
                            Double.parseDouble(txtparcela5.getText())+"','"+
                            data5+"','"+
                            data+"','"+
                            Double.parseDouble(lblsaldo.getText())+"')";
                    con_contapagar1.statement.executeUpdate(sqlinsertcontap5);
...
// TODO add your handling code h
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VendaCarteira().setVisible(true);
            }
        });
    }

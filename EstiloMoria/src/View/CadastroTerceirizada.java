/*
 * CadastroTerceirizada.java
 *
 * Created on 31 de Agosto de 2011, 19:51
 */
 ...
 */
public class CadastroTerceirizada extends javax.swing.JFrame {
    private int numeroRegistros = 0;
    private conexao con_terceirizada;
    /** Creates new form CadastroTerceirizada */
    public CadastroTerceirizada() throws SQLException {
        initComponents();
         setResizable(false);
        con_terceirizada = new conexao();
        con_terceirizada.conecta();
        con_terceirizada.executeSQL("select MAX (cd_terceirizada+1) AS Codigo from Terceirizada");
        con_terceirizada.resultset.next();
        txtcodigo.setText(con_terceirizada.resultset.getString("Codigo"));
...
// Enter simula tecla Tab
    ...
    private void initComponents() {
        ...
        setTitle("Cadastro Terceirizada");
        ...
        lblinvalido.setBounds(370, 20, 50, 10);
        ...
        lblinvalido1.setBounds(60, 120, 50, 10);
        ...
        lblvalido1.setBounds(60, 120, 34, 13);
...
// TODO add your handling code here:
        ...
        try {
            if(txtnome.getText().equals("")){
                ...
                String sqlintterceirizada = "insert into terceirizada (cd_terceirizada, cd_cpf_terceirizada, nm_contato) values ('"+Integer.parseInt(txtcodigo.getText())+"','"+
                        ftxtcpf.getText().replace(".","").replace("-","")+"','"+
                        txtnome.getText().toUpperCase()+"')";
                String sqlinsertemail ="insert into email (cd_terceirizada, nm_email1) values ('"+Integer.parseInt(txtcodigo.getText())+"','"+
                        txtemail.getText().toLowerCase()+"')";
                String sqlinserttel ="insert into telefone (cd_terceirizada, cd_tel1,cd_tel2,cd_tel3,cd_tel4) values ('"+Integer.parseInt(txtcodigo.getText())+"','"+
                ...
                String sqlinsertendereco ="insert into endereco (cd_terceirizada, nm_logradouro, cd_numero, nm_complemento, nm_bairro, " +
                ...
                con_terceirizada.statement.executeUpdate(sqlintterceirizada);
                con_terceirizada.statement.executeUpdate(sqlinsertemail);
                con_terceirizada.statement.executeUpdate(sqlinserttel);
                con_terceirizada.statement.executeUpdate(sqlinsertendereco);
...
// Só aceita numero
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new CadastroTerceirizada().setVisible(true);

 ...
 */
public class ContaReceberCarteira_1 extends javax.swing.JFrame {
...
// Enter simula tecla Tab
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item", "Cliente", "Produto", "Cor", "Tam.", "Qtd.", "V. Unit.", "V. Total", "Pagamento", "Data Compra", "Data Venc."
            }
        ));
        ...
        jScrollPane1.setBounds(10, 140, 810, 220);
        ...
        setBounds((screenSize.width-836)/2, (screenSize.height-450)/2, 836, 450);
...
// TODO add your handling code here:
    ...
    public void preenchejTablaData(){
        ...
        jTable1.getColumnModel().getColumn(5).setPreferredWidth(39);
        ...
        jTable1.getColumnModel().getColumn(9).setPreferredWidth(82);
        ...
        try {
            con_cliente= new conexao();
            con_cliente.conecta();
            con_cliente.executeSQL("SELECT m.dt_venda, cl.nm_cliente, p.nm_produto, c.nm_cor, m.nm_tamanho, m.qt_quantidade, m.vl_unitario, m.vl_sbtl FROM vendacarteira as m  NATURAL JOIN cliente as cl NATURAL JOIN cor as c NATURAL JOIN produto as p where dt_venda = '"
                    + data + "'order by dt_venda");
    ...
    public void preenchejTablaCliente(){
        ...
        try {
            con_cliente= new conexao();
            con_cliente.conecta();
            con_cliente.executeSQL("SELECT m.dt_venda, cl.nm_cliente, p.nm_produto, c.nm_cor, m.nm_tamanho, m.qt_quantidade, m.vl_unitario, m.vl_sbtl FROM vendacarteira as m  NATURAL JOIN cliente as cl NATURAL JOIN cor as c NATURAL JOIN produto as p where nm_cliente LIKE  '"
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ContaReceberCarteira_1().setVisible(true);
            }
        });
    }

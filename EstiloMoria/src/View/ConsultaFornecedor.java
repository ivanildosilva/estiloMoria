 ...
 *
 * Created on 6 de Setembro de 2011, 13:01
 */
...
public class ConsultaFornecedor extends javax.swing.JFrame {
   ...
   con_cliente=new conexao();
        ...
        con_cliente.executeSQL("Select f.*, t.*, en.*, e.nm_email1 FROM Fornecedor f Left Join Telefone t ON (f.cd_fornecedor=t.cd_fornecedor) left join email e on (f.cd_fornecedor=e.cd_fornecedor) left join endereco en on (f.cd_fornecedor=en.cd_fornecedor) order by nm_razaosocial_fornecedor");
        ...
        try {
            while(con_cliente.resultset.next())
                cmbnome.addItem(con_cliente.resultset.getString("nm_razaosocial_fornecedor"));
...
// Enter simula tecla Tab
    ...
    private void initComponents() {
        ...
        jPanel1.add(cmbnome);
        cmbnome.setBounds(70, 40, 240, 20);

        jLabel2.setText("Raz\u00e3o Social");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(70, 20, 90, 14);

        jLabel3.setText("CNPJ");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(320, 20, 50, 14);

        ftxtcnpj.setEnabled(false);
        jPanel1.add(ftxtcnpj);
        ftxtcnpj.setBounds(320, 40, 120, 20);
...
// TODO add your handling code here:
    ...
    private void btnalterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnalterarActionPerformed
        try {
            ...
            String sql1 = "UPDATE Email Set nm_email1='"+txtemail.getText().toLowerCase()+"' where cd_fornecedor='"+txtcodigo.getText()+"'";
            ...
            String sql2 = "UPDATE Telefone Set cd_tel1='"+ftxttel1.getText().replace("(","").replace(")","").replace("-","")+"',"+
                    ...
                    "cd_tel4='"+ftxttel4.getText().replace("(","").replace(")","").replace("-","")+"' where cd_fornecedor ='"+txtcodigo.getText()+"'";
            ...
            String sql4 = "UPDATE Endereco Set cd_cep='"+ftxtcep.getText().replace(".","").replace("-","")+"',"+
                    ...
                    "cd_numero='"+txtnumero.getText()+"' where cd_fornecedor ='"+txtcodigo.getText()+"'";
...
// TODO add your handling code here:
        ...
        try {
            ...
            if(opcao_escolha==JOptionPane.YES_OPTION){
                String sql = "DELETE from fornecedor where cd_fornecedor="+Integer.parseInt(txtcodigo.getText());
                ...
                if(conseguiu_excluir==1){
                    ...
                    con_endereco.executeSQL("Select f.*, t.*, en.*, e.nm_email1 FROM Fornecedor f Left Join Telefone t ON (f.cd_fornecedor=t.cd_fornecedor) left join email e on (f.cd_fornecedor=e.cd_fornecedor) left join endereco en on (f.cd_fornecedor=en.cd_fornecedor) order by nm_razaosocial_fornecedor");
                    con_endereco.resultset.first();
                    con_email.executeSQL("Select f.*, t.*, en.*, e.nm_email1 FROM Fornecedor f Left Join Telefone t ON (f.cd_fornecedor=t.cd_fornecedor) left join email e on (f.cd_fornecedor=e.cd_fornecedor) left join endereco en on (f.cd_fornecedor=en.cd_fornecedor) order by nm_razaosocial_fornecedor");
                    con_email.resultset.first();
                    con_telefone.executeSQL("Select f.*, t.*, en.*, e.nm_email1 FROM Fornecedor f Left Join Telefone t ON (f.cd_fornecedor=t.cd_fornecedor) left join email e on (f.cd_fornecedor=e.cd_fornecedor) left join endereco en on (f.cd_fornecedor=en.cd_fornecedor) order by nm_razaosocial_fornecedor");
...
// TODO add your handling code here:
        ...
        try {
            ...
            String igual = "n";
            while(igual == "n"){
                if(con_cliente.resultset.getString("nm_razaosocial_fornecedor").equals(cmbnome.getSelectedItem())){
                    igual = "s";
                } else
                    con_cliente.resultset.next();
            }
        ...
        try {
            ...
            txtcodigo.setText(con_cliente.resultset.getString(String.valueOf("cd_fornecedor")));
            ftxtcnpj.setText(con_cliente.resultset.getString(String.valueOf("cd_cnpj_fornecedor")));

 ...
 *
 * Created on 6 de Setembro de 2011, 12:00
 */
...
public class ConsultaVendedor extends javax.swing.JFrame {
   private  MaskFormatter FormatoData, FormatoCpf, FormatoCnpj, FormatoCep, FormatoTel1, FormatoTel2, FormatoTel3, FormatoTel4;
    ...
    public ConsultaVendedor() {
        ...
        con_cliente.executeSQL("Select c.cd_vendedor, c.cd_cpf_vendedor, c.nm_vendedor, t.*, en.*, e.nm_email1 FROM Vendedor c Left Join Telefone t ON (c.cd_vendedor=t.cd_vendedor) left join email e on (c.cd_vendedor=e.cd_vendedor) left join endereco en on (c.cd_vendedor=en.cd_vendedor) order by nm_vendedor");
        ...
        try {
            while(con_cliente.resultset.next())
                cmbnome.addItem(con_cliente.resultset.getString("nm_vendedor"));
...
// TODO add your handling code here:
    ...
    private void btnalterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnalterarActionPerformed
        try {
            ...
            String sql1 = "UPDATE Email Set nm_email1='"+txtemail.getText().toLowerCase()+"' where cd_vendedor ='"+txtcodigo.getText()+"'";
       ...
       //isso serve para atualuzar o resultset
            ...
            String sql2 = "UPDATE Telefone Set cd_tel1='"+ftxttel1.getText().replace("(","").replace(")","").replace("-","")+"',"+
                    ...
                    "cd_tel4='"+ftxttel4.getText().replace("(","").replace(")","").replace("-","")+"' where cd_vendedor ='"+txtcodigo.getText()+"'";
            ...
            String sql4 = "UPDATE Endereco Set cd_cep='"+ftxtcep.getText().replace(".","").replace("-","")+"',"+
                    ...
                    "cd_numero='"+txtnumero.getText()+"' where cd_vendedor ='"+txtcodigo.getText()+"'";
...
// TODO add your handling code here:
        ...
        try {
            ...
            if(opcao_escolha==JOptionPane.YES_OPTION){
                String sql = "DELETE from vendedor where cd_vendedor="+Integer.parseInt(txtcodigo.getText());
                ...
                if(conseguiu_excluir==1){
                    ...
                    con_endereco.executeSQL("Select c.cd_vendedor, c.cd_cpf_vendedor, c.nm_vendedor, t.*, en.*, e.nm_email1 FROM Vendedor c Left Join Telefone t ON (c.cd_vendedor=t.cd_vendedor) left join email e on (c.cd_vendedor=e.cd_vendedor) left join endereco en on (c.cd_vendedor=en.cd_vendedor) order by nm_vendedor");
                    con_endereco.resultset.first();
                    con_email.executeSQL("Select c.cd_vendedor, c.cd_cpf_vendedor, c.nm_vendedor, t.*, en.*, e.nm_email1 FROM Vendedor c Left Join Telefone t ON (c.cd_vendedor=t.cd_vendedor) left join email e on (c.cd_vendedor=e.cd_vendedor) left join endereco en on (c.cd_vendedor=en.cd_vendedor) order by nm_vendedor");
                    con_email.resultset.first();
                    con_telefone.executeSQL("Select c.cd_vendedor, c.cd_cpf_vendedor, c.nm_vendedor, t.*, en.*, e.nm_email1 FROM Vendedor c Left Join Telefone t ON (c.cd_vendedor=t.cd_vendedor) left join email e on (c.cd_vendedor=e.cd_vendedor) left join endereco en on (c.cd_vendedor=en.cd_vendedor) order by nm_vendedor");
...
// TODO add your handling code here:
        ...
        try {
            ...
            String igual = "n";
            while(igual == "n"){
                if(con_cliente.resultset.getString("nm_vendedor").equals(cmbnome.getSelectedItem())){
                    igual = "s";
                } else
                    con_cliente.resultset.next();
            }
        ...
        try {
            ...
            txtcodigo.setText(con_cliente.resultset.getString(String.valueOf("cd_vendedor")));
            ftxtcpf.setText(con_cliente.resultset.getString(String.valueOf("cd_cpf_vendedor")));

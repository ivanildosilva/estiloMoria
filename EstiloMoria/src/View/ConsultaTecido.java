 ...
 */
public class ConsultaTecido extends javax.swing.JFrame {
    ...
    public ConsultaTecido() throws SQLException {
        initComponents();
...
// TODO add your handling code here:
        ...
        if(iniciacombo == 1){
            try {
                ...
                txtcodigo.setText(con_produto.resultset.getString(String.valueOf("cd_tecido")));
...
// TODO add your handling code here:
        ...
        try {
            ...
            if(txtproduto.getText().equals("")||txtproduto.getText().equals("-") ){
                ...
                JOptionPane.showMessageDialog(null,"Selecione um tecido!");
                cmbproduto.requestFocus();
            } else{
                
                String sql1 = "UPDATE Tecido Set nm_tecido='"+txtproduto.getText().toUpperCase()+"' where cd_tecido ='"+(txtcodigo.getText())+"'";
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ConsultaTecido().setVisible(true);
                } catch (SQLException ex) {
                    ex.printStackTrace();
                }
            }

...
// Enter simula tecla Tab
    ...
    private void initComponents() {
        ...
        setTitle("Consulta Venda Balc\u00e3o");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item", "Cliente", "Produto", "Cor", "Tam.", "Qtd.", "V. Unit.", "V. Total", "Pagamento", "Data"
            }
        ));
...
// TODO add your handling code here:
    ...
    public void preenchejTablaData(){
        ...
        try {
            ...
            con_cliente.conecta();
            con_cliente.executeSQL("SELECT m.dt_venda, cl.nm_cliente, p.nm_produto, c.nm_cor, m.nm_tamanho, m.qt_quantidade, m.vl_unitario, m.vl_sbtl, m.vl_ttlgeral,m.nm_formapagamento FROM vendadireta as m  NATURAL JOIN cliente as cl NATURAL JOIN cor as c NATURAL JOIN produto as p where dt_venda = '"
                    + data + "'order by dt_venda");
            
            while(con_cliente.resultset.next())
                
                //  txtfornecedor1.setText(con_cliente.resultset.getString("nm_razaosocial_fornecedor"));
                modelo.addRow(new Object []{numeroRegistros++, con_cliente.resultset.getString("nm_cliente"),con_cliente.resultset.getString("nm_produto"),con_cliente.resultset.getString("nm_cor"),con_cliente.resultset.getString("nm_tamanho"),con_cliente.resultset.getString("qt_quantidade"),converterDoubleString(con_cliente.resultset.getDouble("vl_unitario")),converterDoubleString(con_cliente.resultset.getDouble("vl_sbtl")),con_cliente.resultset.getString("nm_formapagamento"),new SimpleDateFormat("dd/MM/yyyy").format(con_cliente.resultset.getDate("dt_venda"))});
        ...
        try {
            con_cliente= new conexao();
            con_cliente.conecta();
            con_cliente.executeSQL("SELECT m.dt_venda, cl.nm_cliente, p.nm_produto, c.nm_cor, m.nm_tamanho, m.qt_quantidade, m.vl_unitario, m.vl_sbtl, m.nm_formapagamento FROM vendadireta as m  NATURAL JOIN cliente as cl NATURAL JOIN cor as c NATURAL JOIN produto as p where dt_venda = '"
                    + data + "'order by dt_venda");
    ...
    public void preenchejTablaCliente(){
        ...
        try {
            con_cliente= new conexao();
            con_cliente.conecta();
            con_cliente.executeSQL("SELECT m.dt_venda, cl.nm_cliente, p.nm_produto, c.nm_cor, m.nm_tamanho, m.qt_quantidade, m.vl_unitario, m.vl_sbtl, m.nm_formapagamento FROM vendadireta as m  NATURAL JOIN cliente as cl NATURAL JOIN cor as c NATURAL JOIN produto as p where nm_cliente LIKE  '"

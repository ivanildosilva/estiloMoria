 ...
 *
 * Created on 31 de Agosto de 2011, 20:12
 */
...
public class CadastroFornecedor extends javax.swing.JFrame {
    ...
    private conexao con_fornecedor;
    ...
    public CadastroFornecedor() throws SQLException {
        ...
        con_fornecedor.executeSQL("select MAX (cd_fornecedor+1) AS Codigo from Fornecedor");
        con_fornecedor.resultset.next();
        txtcodigo.setText(con_fornecedor.resultset.getString("Codigo"));
...
// Enter simula tecla Tab
    ...
    private void initComponents() {
        ...
        txtcodigo.setBounds(10, 40, 40, 20);
        ...
        jPanel2.add(txtnome);
        txtnome.setBounds(60, 40, 240, 20);

        lblnome2.setText("Raz\u00e3o");
        jPanel2.add(lblnome2);
        lblnome2.setBounds(60, 20, 60, 14);

        jPanel2.add(txtfantasia);
        txtfantasia.setBounds(10, 90, 220, 20);

        lblnome3.setText("Fantasia");
        jPanel2.add(lblnome3);
        lblnome3.setBounds(10, 70, 60, 14);
        ...
        ftxtcnpj.setBounds(310, 40, 130, 20);

        lblnome7.setText("CNPJ");
        jPanel2.add(lblnome7);
        lblnome7.setBounds(310, 20, 80, 14);
        ...
        ftxttel1.setBounds(10, 140, 100, 20);

        lblnome8.setText("Tel.1");
        jPanel2.add(lblnome8);
        lblnome8.setBounds(10, 120, 80, 14);

        jPanel2.add(ftxttel2);
        ftxttel2.setBounds(120, 140, 100, 20);

        lblnome9.setText("Tel.2");
        jPanel2.add(lblnome9);
        lblnome9.setBounds(120, 120, 80, 14);

        jPanel2.add(ftxttel3);
        ftxttel3.setBounds(230, 140, 100, 20);

        lblnome10.setText("Tel.3");
        jPanel2.add(lblnome10);
        lblnome10.setBounds(230, 120, 80, 14);

        jPanel2.add(ftxttel4);
        ftxttel4.setBounds(340, 140, 100, 20);

        lblnome11.setText("Tel.4");
        jPanel2.add(lblnome11);
        lblnome11.setBounds(340, 120, 80, 14);
        ...
        txtemail.setBounds(240, 90, 200, 20);

        lblnome12.setText("Email");
        jPanel2.add(lblnome12);
        lblnome12.setBounds(240, 70, 50, 14);
        ...
        lblnome4.setText("Observa\u00e7\u00e3o");
        jPanel2.add(lblnome4);
        lblnome4.setBounds(10, 170, 80, 14);
        ...
        lblvalido.setBounds(350, 20, 34, 13);
        ...
        lblinvalido.setBounds(350, 20, 50, 10);
        ...
        lblvalido1.setBounds(290, 70, 34, 13);
        ...
        lblinvalido1.setBounds(290, 70, 50, 10);
        ...
        setBounds((screenSize.width-482)/2, (screenSize.height-457)/2, 482, 457);
...
// TODO add your handling code here:
        ...
        try {
            if(txtnome.getText().equals("")){
                ...
                String sqlintfornecedor = "insert into fornecedor (cd_fornecedor, cd_cnpj_fornecedor, nm_razaosocial_fornecedor, nm_fantasia_fornecedor) values ('"+Integer.parseInt(txtcodigo.getText())+"','"+
                        ftxtcnpj.getText().replace(".","").replace("-","").replace("/","")+"','"+
                        txtnome.getText().toUpperCase()+"','"+
                        txtfantasia.getText().toUpperCase()+"')";
                String sqlinsertemail ="insert into email (cd_fornecedor, nm_email1) values ('"+Integer.parseInt(txtcodigo.getText())+"','"+
                        txtemail.getText().toLowerCase()+"')";
                String sqlinserttel ="insert into telefone (cd_fornecedor, cd_tel1,cd_tel2,cd_tel3,cd_tel4) values ('"+Integer.parseInt(txtcodigo.getText())+"','"+
                ...
                String sqlinsertendereco ="insert into endereco (cd_fornecedor, nm_logradouro, cd_numero, nm_complemento, nm_bairro, " +
                ...
                con_fornecedor.statement.executeUpdate(sqlintfornecedor);
                con_fornecedor.statement.executeUpdate(sqlinsertemail);
                con_fornecedor.statement.executeUpdate(sqlinserttel);
                con_fornecedor.statement.executeUpdate(sqlinsertendereco);

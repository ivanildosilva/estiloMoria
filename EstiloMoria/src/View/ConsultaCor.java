...
public class ConsultaCor extends javax.swing.JFrame {
    ...
    public ConsultaCor() throws SQLException {
        initComponents();
        ...
        setResizable(false);
        con_produto.executeSQL("select * from Cor order by nm_cor");
        
        try {
            
            while(con_produto.resultset.next())
                cmbproduto.addItem(con_produto.resultset.getString("nm_cor"));
...
// TODO add your handling code here:
        ...
        if(iniciacombo == 1){
            try {
                ...
                String igual = "n";
                while(igual == "n"){
                    if(con_produto.resultset.getString("nm_cor").equals(cmbproduto.getSelectedItem())){
                        igual = "s";
                    } else
                        con_produto.resultset.next();
                }
                txtcodigo.setText(con_produto.resultset.getString(String.valueOf("cd_cor")));
...
// TODO add your handling code here:
        ...
        try {
            ...
            if(txtproduto.getText().equals("")||txtproduto.getText().equals("-") ){
                ...
                JOptionPane.showMessageDialog(null,"Selecione um cor!");
                cmbproduto.requestFocus();
            } else{
                
                String sql1 = "UPDATE Cor Set nm_cor='"+txtproduto.getText().toUpperCase()+"' where cd_cor ='"+(txtcodigo.getText())+"'";

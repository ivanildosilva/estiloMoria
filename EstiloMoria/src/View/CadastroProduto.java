...
public class CadastroProduto extends javax.swing.JFrame {
    ...
    con_produto= new conexao();
        con_produto.conecta();
        con_produto.executeSQL("select MAX (cd_produto+1) AS Codigo from produto");
        con_produto.resultset.next();
        txtcodigo.setText(con_produto.resultset.getString("Codigo"));
         setResizable(false);
...
// Enter simula tecla Tab
    ...
    private void initComponents() {
        ...
        txtproduto.setBounds(60, 30, 210, 20);
...
// TODO add your handling code here:
        ...
        try {
            ...
            if(txtproduto.getText().equals("")){
                ...
                String sqlinsertproduto ="insert into produto (cd_produto, nm_produto) values ('"+Integer.parseInt(txtcodigo.getText())+"','"+
                        txtproduto.getText().toUpperCase()+"')";
                
                              
                
                //  JOptionPane.showMessageDialog(null,"sql = "+sqlinsert);
                con_produto.statement.executeUpdate(sqlinsertproduto);
